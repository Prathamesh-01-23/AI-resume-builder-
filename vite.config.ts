    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          utils: ['zustand', 'date-fns', 'class-variance-authority', 'clsx', 'tailwind-merge'],
          icons: ['lucide-react'],
          forms: ['react-hook-form', 'cmdk', 'input-otp', 'react-day-picker', 'react-beautiful-dnd', 'embla-carousel-react', 'recharts', 'vaul']
        }
      }
    },
